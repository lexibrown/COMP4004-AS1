...
import main.java.com.comp4004.database.BookDatabase;
import main.java.com.comp4004.database.LoanDatabase;
import main.java.com.comp4004.database.ReservationDatabase;
import main.java.com.comp4004.database.UserDatabase;
import main.java.com.comp4004.model.Book;
import main.java.com.comp4004.model.Copy;
import main.java.com.comp4004.model.Loan;
import main.java.com.comp4004.model.Reservation;
...
public class ServerController {
	...
	/**
	 * Returns if book is currently reserved
	 * 
	 * @param ISBN
	 * @param copyNumber
	 * @return
	 */
	public boolean isReserved(int ISBN, int copyNumber) {
		return reservationDatabase.findReservation(ISBN, copyNumber) != null;
	}

	/**
	 * Returns if book is currently reserved by passed in user
	 * 
	 * @param ISBN
	 * @param copyNumber
	 * @param userId
	 * @return
	 */
	public boolean isReserved(int ISBN, int copyNumber, String username) {
		int userId = userDatabase.findUser(username).getUserId();
		return reservationDatabase.findReservation(ISBN, copyNumber, userId) != null;
	}

	/**
	 * Returns if book is currently borrowed
	 * 
	 * @param ISBN
	 * @param copyNumber
	 * @return
	 */
	public boolean isBorrowed(int ISBN, int copyNumber) {
		return loanDatabase.findLoan(ISBN, copyNumber) != null;
	}

	/**
	 * Return if book is currently borrowed by passed in user
	 * 
	 * @param ISBN
	 * @param copyNumber
	 * @param username
	 * @return
	 */
	public boolean isBorrowed(int ISBN, int copyNumber, String username) {
		int userId = userDatabase.findUser(username).getUserId();
		return loanDatabase.findLoan(ISBN, copyNumber, userId) != null;
	}
